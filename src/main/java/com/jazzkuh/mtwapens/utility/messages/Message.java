...
public enum Message {
    ...
    SHOT_INFO_DURABILITY("shot.info.durability", "&9Durability: <sc><durability>"),
    SHOT_INFO_AMMO("shot.info.ammo", "&9Ammo: <sc><ammo>&f/&c<max-ammo>"),
    SHOT_HIT_YOU("shot.hit.you", "&cJe hebt &4<player> &cgeraakt met jouw schot!"),
    SHOT_HIT_OTHER("shot.hit.other", "&cJe bent beschoten door &4<player>&c."),
